...
namespace SGI.Api.Migrations
{
    ...
    [Migration("20260618112327_MatriculaComoRegistroFuncional")]
    partial class MatriculaComoRegistroFuncional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGI.Api.Dominio.Matricula", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SGI.Api.Dominio.Mandato", b =>
                {
                    ...
                    b.HasOne("SGI.Api.Dominio.Matricula", "Matricula")
                        .WithOne("Mandato")
                        .HasForeignKey("SGI.Api.Dominio.Mandato", "MatriculaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SGI.Api.Dominio.Vinculo", b =>
                {
                    ...
                    b.HasOne("SGI.Api.Dominio.Matricula", "Matricula")
                        .WithOne("Vinculo")
                        .HasForeignKey("SGI.Api.Dominio.Vinculo", "MatriculaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
